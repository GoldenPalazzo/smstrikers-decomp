...
public:
    ...
    unsigned short FindDumpDirection(unsigned short, bool);
    void HandleSTSSwat();
    ...
    bool IsInsideNetArea(const nlVector3&);
    ...
    void ChooseDesperationAnim(float);
    void InitActionSaveReposition();
    void InitActionLooseBallPursueBouncing(const nlVector3&, float);
    void InitActionLooseBallPursueRolling();
    void InitActionLooseBallPickup(float, bool);
    void InitActionOffplay(eGoalieOffplayType);
    void InitActionSTSAttackSetup(float);
