...
public:
    ...
    bool InitDesireWindupPass(cPlayer*, bool);
    void DesireUsePowerup(float);
    void InitDesireUsePowerup(ePowerUpType, cFielder*);
    void DesireHit(float);
    void InitDesireHit(cFielder*);
    void DesireWait(float);
    void InitDesireWait();
    ...
    void InitDesireSlideAttack(cFielder*);
    void DesireRunToLocation(float);
    void InitDesireRunToLocation(const nlVector3&, bool);
    void DesireRunDownField(float);
    void InitDesireRunDownField();
    void DesireRunUpField(float);
    void InitDesireRunUpField();
    void DesireDeke(float);
    void InitDesireDeke();
    void DesireShoot(float);
    void InitDesireShoot(bool, bool);
    void DesirePass(float);
    void InitDesirePass(cPlayer*, bool);
    ...
    bool InitDesire(eFielderDesireState, float, float, FuzzyVariant, FuzzyVariant);
