...
asm void PSMTX44Copy(const register Mtx44 src, register Mtx44 dst)
{
    nofralloc
        psq_l f1,
        0x0(src), 0, 0 psq_st f1, 0x0(dst), 0, 0 psq_l f1, 0x8(src), 0, 0 psq_st f1, 0x8(dst), 0, 0 psq_l f1, 0x10(src), 0, 0 psq_st f1, 0x10(dst), 0, 0 psq_l f1, 0x18(src), 0, 0 psq_st f1, 0x18(dst), 0, 0 psq_l f1, 0x20(src), 0, 0 psq_st f1, 0x20(dst), 0, 0 psq_l f1, 0x28(src), 0, 0 psq_st f1, 0x28(dst), 0, 0 psq_l f1, 0x30(src), 0, 0 psq_st f1, 0x30(dst), 0, 0 psq_l f1, 0x38(src), 0, 0 psq_st f1, 0x38(dst), 0, 0 blr
}
...
asm void PSMTX44Concat(const register Mtx44 a, const register Mtx44 b, register Mtx44 ab)
{
    nofralloc
        psq_l f0,
        0x0(a), 0, 0 psq_l f2, 0x0(b), 0, 0 ps_muls0 f6, f2, f0 psq_l f3, 0x10(b), 0, 0 psq_l f4, 0x20(b), 0, 0 ps_madds1 f6, f3, f0, f6 psq_l f1, 0x8(a), 0, 0 psq_l f5, 0x30(b), 0, 0 ps_madds0 f6, f4, f1, f6 psq_l f0, 0x10(a), 0, 0 ps_madds1 f6, f5, f1, f6 psq_l f1, 0x18(a), 0, 0 ps_muls0 f8, f2, f0 ps_madds1 f8, f3, f0, f8 psq_l f0, 0x20(a), 0, 0 ps_madds0 f8, f4, f1, f8 ps_madds1 f8, f5, f1, f8 psq_l f1, 0x28(a), 0, 0 ps_muls0 f10, f2, f0 ps_madds1 f10, f3, f0, f10 psq_l f0, 0x30(a), 0, 0 ps_madds0 f10, f4, f1, f10 ps_madds1 f10, f5, f1, f10 psq_l f1, 0x38(a), 0, 0 ps_muls0 f12, f2, f0 psq_l f2, 0x8(b), 0, 0 ps_madds1 f12, f3, f0, f12 psq_l f0, 0x0(a), 0, 0 ps_madds0 f12, f4, f1, f12 psq_l f3, 0x18(b), 0, 0 ps_madds1 f12, f5, f1, f12 psq_l f1, 0x8(a), 0, 0 ps_muls0 f7, f2, f0 psq_l f4, 0x28(b), 0, 0 ps_madds1 f7, f3, f0, f7 psq_l f5, 0x38(b), 0, 0 ps_madds0 f7, f4, f1, f7 psq_l f0, 0x10(a), 0, 0 ps_madds1 f7, f5, f1, f7 psq_l f1, 0x18(a), 0, 0 ps_muls0 f9, f2, f0 psq_st f6, 0x0(ab), 0, 0 ps_madds1 f9, f3, f0, f9 psq_l f0, 0x20(a), 0, 0 ps_madds0 f9, f4, f1, f9 psq_st f8, 0x10(ab), 0, 0 ps_madds1 f9, f5, f1, f9 psq_l f1, 0x28(a), 0, 0 ps_muls0 f11, f2, f0 psq_st f10, 0x20(ab), 0, 0 ps_madds1 f11, f3, f0, f11 psq_l f0, 0x30(a), 0, 0 ps_madds0 f11, f4, f1, f11 psq_st f12, 0x30(ab), 0, 0 ps_madds1 f11, f5, f1, f11 psq_l f1, 0x38(a), 0, 0 ps_muls0 f13, f2, f0 psq_st f7, 0x8(ab), 0, 0 ps_madds1 f13, f3, f0, f13 psq_st f9, 0x18(ab), 0, 0 ps_madds0 f13, f4, f1, f13 psq_st f11, 0x28(ab), 0, 0 ps_madds1 f13, f5, f1, f13 psq_st f13, 0x38(ab), 0, 0 blr
}
...
asm void PSMTX44TransApply(const register Mtx44 src, register Mtx44 dst, register f32 xT, register f32 yT, register f32 zT)
{
    nofralloc
        psq_l f4,
        0x0(src), 0, 0 frsp xT, xT psq_l f5, 0x8(src), 0, 0 frsp yT, yT psq_l f6, 0x10(src), 0, 0 frsp zT, zT psq_l f7, 0x18(src), 0, 0 psq_st f4, 0x0(dst), 0, 0 ps_sum1 f5, xT, f5, f5 psq_l f4, 0x28(src), 0, 0 psq_st f6, 0x10(dst), 0, 0 ps_sum1 f7, yT, f7, f7 psq_l f8, 0x20(src), 0, 0 psq_st f5, 0x8(dst), 0, 0 ps_sum1 f4, zT, f4, f4 psq_st f7, 0x18(dst), 0, 0 psq_st f8, 0x20(dst), 0, 0 psq_l f5, 0x30(src), 0, 0 psq_l f6, 0x38(src), 0, 0 psq_st f4, 0x28(dst), 0, 0 psq_st f5, 0x30(dst), 0, 0 psq_st f6, 0x38(dst), 0, 0 blr
}
...
asm void PSMTX44ScaleApply(const register Mtx44 src, register Mtx44 dst, register f32 xS, register f32 yS, register f32 zS)
{
    nofralloc
        psq_l f4,
        0x0(src), 0, 0 frsp xS, xS psq_l f5, 0x8(src), 0, 0 frsp yS, yS psq_l f6, 0x10(src), 0, 0 ps_muls0 f4, f4, xS psq_l f7, 0x18(src), 0, 0 ps_muls0 f5, f5, xS psq_l f8, 0x20(src), 0, 0 frsp zS, zS psq_st f4, 0x0(dst), 0, 0 ps_muls0 f6, f6, yS psq_l f9, 0x28(src), 0, 0 psq_st f5, 0x8(dst), 0, 0 ps_muls0 f7, f7, yS psq_l f10, 0x30(src), 0, 0 psq_st f6, 0x10(dst), 0, 0 ps_muls0 f8, f8, zS psq_l f11, 0x38(src), 0, 0 psq_st f7, 0x18(dst), 0, 0 ps_muls0 f9, f9, zS psq_st f8, 0x20(dst), 0, 0 psq_st f9, 0x28(dst), 0, 0 psq_st f10, 0x30(dst), 0, 0 psq_st f11, 0x38(dst), 0, 0 blr
}
