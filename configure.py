...
config.libs = [
    ...
    GameLib(
        ...
        [
            ...
            Object(MatchingFor("G4QE01", "G4QJ01"), "Game/OverlayHandlerHUD.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            Object(MatchingFor("G4QE01", "G4QJ01"), "Game/OverlayHandlerInGameText.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
