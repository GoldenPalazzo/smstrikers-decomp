...
config.libs = [
    ...
    RuntimeLib_MSL_C(
        ...
        [
            ...
            Object(MatchingFor("G4QE01"), "PowerPC_EABI_Support/MSL/MSL_C/MSL_Common/s_ldexp.c", extra_cflags=["-inline auto"]),
    ...
    GameLib(
        ...
        [
            ...
            Object(MatchingFor("G4QE01"), "Game/CharacterTweaks.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/FormationDefines.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/Audio/GameAudio.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            Object(MatchingFor("G4QE01"), "Game/Audio/audio.cpp", extra_cflags=["-inline deferred"]),
            Object(MatchingFor("G4QE01"), "Game/Audio/SebringSoundDefines.cpp" , extra_cflags=["-inline auto", "-inline deferred"]),
            ...
            # Physics
            Object(MatchingFor("G4QE01"), "Game/Physics.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/AI/Variant.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/FE/feSoundKeyframeTrigger.cpp", extra_cflags=["-inline auto"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/FE/feCaptainComponent.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            Object(MatchingFor("G4QE01"), "Game/FE/feTweener.cpp", extra_cflags=["-inline auto"]),
            Object(MatchingFor("G4QE01"), "Game/FE/feSceneManager.cpp", extra_cflags=["-inline auto"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/FE/FEAudio.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/GL/ShaderSkinMesh.cpp", extra_cflags=["-inline auto", "-inline deferred"]),

            # FX
            Object(MatchingFor("G4QE01"), "Game/objectblur.cpp", extra_cflags=["-inline auto"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/SoundProps/stadpalacesoundproperties.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
            ...
            Object(MatchingFor("G4QE01"), "Game/DB/StatsTracker.cpp", extra_cflags=["-inline auto", "-inline deferred"]),
    ...
    GameLib(
        ...
        [
            ...
            Object(MatchingFor("G4QE01"), "NL/glx/glxMemory.cpp", extra_cflags=["-inline auto"]),
    ...
    ODELib(
        ...
        [
            ...
            Object(MatchingFor("G4QE01"), "ode/memory.cpp", extra_cflags=["-inline auto"]),
    ...
    MusyxLib(
        ...
        [
            ...
            Object(MatchingFor("G4QE01"), "musyx/runtime/synth_vsamples.c", extra_cflags=["-inline auto"]),
            ...
            Object(MatchingFor("G4QE01"), "musyx/runtime/StdReverb/reverb_fx.c", extra_cflags=["-inline auto"]),
